...
var waypoint = new Waypoint({
  ...
  handler: function(direction) {
    ...
    if (direction === "down") {
      ...
      console.log("way-point 2: Scrolling down... make dots visible")
    } else {
      updateDots('medincome', '#ridership2');
      updateXAxis('medincome', '#ridership2');
      console.log("way-point 2: Scrolling up... updating dots and axis");
    }
  },
  offset: "100%"
})
...
var waypoint = new Waypoint({
  ...
  handler: function(direction) {
    ...
    console.log("waypoint 8 -- add in regression line")
  },
  offset: "100%"
})
...
var waypoint = new Waypoint({
  ...
  handler: function(direction) {
    if (direction === "down") {
      ...
      console.log("waypoint 6 - down - Change x variable to education");
    } else if (direction === "up") {
      updateXAxis('medincome', '#ridership3');
      updateDots('medincome', '#ridership3');
      console.log("waypoint 6 - up - Change x variable to medincome");
    }
  },
  offset: "100%"
})
...
var waypoint = new Waypoint({
  ...
  handler: function(direction) {
    if (direction === "down") {
      ...
      console.log("waypoint 7 - down - Change x variable to white population");
    } else if (direction === "up"){
      console.log("waypoint 7 - up - Change x variable to percent college");
      updateXAxis('pct_college', '#ridership3');
      updateDots('pct_college', '#ridership3');
    }
  },
